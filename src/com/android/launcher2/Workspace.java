...
public class Workspace extends SmoothPagedView
        ...
        DragController.DragListener, LauncherTransitionable, ViewGroup.OnHierarchyChangeListener, OnInterceptTouchListener {
    ...
    /**
     * Check if the user has started a touch that landed on the CellLayout
     * This means it didn't hit anything interesting immediately, and we might
     * want to start pre-scrolling
     *
     */
